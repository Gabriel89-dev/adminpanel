...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="/resources/assets/IMG_20220617_065855_008-removebg-preview.ico" />
</head>
                                    ...
                                    <div class="justify-content-end d-flex">
                                        <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                                            <button class="btn btn-sm btn-light bg-white dropdown-toggle" type="button"
                                                ...
                                                aria-expanded="true">
                                                <i class="mdi mdi-calendar"></i> Today (11 November 2024)
                                            </button>
                                    ...
                                    <ul class="icon-data-list">
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    <p class="text-info mb-1">Muhhamad Faith Azmi</p>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    <p class="text-info mb-1">Ahdanil Hakim</p>
                                                    <p class="mb-0">Sales dashboard have been created</p>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    <p class="text-info mb-1">Fatan Rahman</p>
                                                    <p class="mb-0">Sales dashboard have been created</p>
                                                    <small>8:50 am</small>
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    <p class="text-info mb-1">Erlan Gunawan</p>
